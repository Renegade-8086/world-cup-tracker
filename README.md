...
1. Click this link to download: <a href="https://raw.githubusercontent.com/Renegade-8086/world-cup-tracker/main/current_scores.json" download>Download Current Scores File (current_scores.json)</a>and choose **"Save Link As..."** to save the file to your device.
